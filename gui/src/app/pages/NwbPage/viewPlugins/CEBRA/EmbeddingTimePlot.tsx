...
const EmbeddingTimePlot: FunctionComponent<EmbeddingTimePlotProps> = ({ embedding, binSizeMsec, width, height }) => {
    ...
    const tt = useMemo(() => {
        const t = new Array(numDatapoints).fill(0).map((_, i) => i * binSizeMsec / 1000)
        return t
