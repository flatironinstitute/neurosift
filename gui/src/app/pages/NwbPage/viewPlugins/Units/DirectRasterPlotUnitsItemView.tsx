...
import { DatasetDataType, RemoteH5FileX, RemoteH5Group } from "@remote-h5-file/index"
...
const DirectRasterPlotUnitsItemView: FunctionComponent<Props> = ({width, height, path}) => {
