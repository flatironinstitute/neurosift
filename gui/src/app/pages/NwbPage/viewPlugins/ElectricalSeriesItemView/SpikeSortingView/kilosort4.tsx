...
export const useSpikeSortingKilosort4Step = (prepareEphysJob?: PairioJob) => {
    const [spikeSortingKilosort4Opts, setSpikeSortingKilosort4Opts] = useState<SpikeSortingKilosort4Opts>(
    ...
    const [spikeSortingKilosort4JobId, setSpikeSortingKilosort4JobId] = useState<
      string | undefined
    >(undefined);
    const { job: spikeSortingKilosort4Job, refreshJob: refreshSpikeSortingKilosort4Job } =
