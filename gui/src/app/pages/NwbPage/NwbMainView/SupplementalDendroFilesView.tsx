...
const SupplementalDendroFilesView: FunctionComponent<
  SupplementalDendroFilesViewProps
> = () => {
  const {
        ...
        <tbody>
          {(files || []).map((file, i) => (
            <tr key={i}>
              <td>
                <Checkbox
                  checked={selectedSupplementalFileIds.includes(file.fileId)}
                  onChange={(e) => {
                    if (e.target.checked) {
                      setSelectedSupplementalFileIds([
                        ...selectedSupplementalFileIds,
                      ...
                      setSelectedSupplementalFileIds(
                        selectedSupplementalFileIds.filter(
                          (id) => id !== file.fileId,
                        ),
                      );
                    }
