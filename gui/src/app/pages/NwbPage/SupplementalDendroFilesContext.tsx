...
type SupplementalDendroFilesType = {
    ...
    setSelectedSupplementalFileIds: (selectedSupplementalFileIds: string[]) => void
}
...
export const SupplementalDendroFilesContext = createContext<SupplementalDendroFilesType>(defaultSupplementalDendroFiles)
