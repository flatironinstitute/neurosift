...
type EditContributorsChatWindowProps = {
  ...
  setEditedDandisetMetadata: React.Dispatch<
    React.SetStateAction<Dandiset | null>
  >;
};

const EditContributorsChatWindow: FunctionComponent<
  EditContributorsChatWindowProps
> = ({
  width,
  height,
  chat,
...
========================
${dandisetMetadata && JSON.stringify(dandisetMetadata.contributor, null, 2)}
========================
...
export default EditContributorsChatWindow;
