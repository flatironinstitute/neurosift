...
const TestPage: FunctionComponent<TestPageProps> = () => {
  ...
  return (
    <div style={{ padding: 20 }}>
      <p>
        Click one of the buttons below to run a test, and view the console for
        the results.
      </p>
      <p>
...
const test_lindi = async () => {
  ...
  const lindi_url =
    "https://lindi.neurosift.org/dandi/dandisets/000409/assets/c04f6b30-82bf-40e1-9210-34f0bcd8be24/nwb.lindi.json";
  const object_name = "/acquisition/ElectricalSeriesAp/data";
  const slice = [[0, 20]] as [number, number][];
