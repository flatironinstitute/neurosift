...
} from "../NwbPage/NeurosiftAnnotations/types";
...
const AnnotationsPage: FunctionComponent<AnnotationsPageProps> = ({
  width,
  height,
}) => {
                    ...
                    <Hyperlink
                      onClick={() => {
                        setRoute({
                          ...
                          storageType: [
                            (annotation.assetPath || "").endsWith(".json")
                              ? "lindi"
                              : "h5",
                          ],
                        });
...
const AnnotationContentView: FunctionComponent<AnnotationContentViewProps> = ({
  annotation,
}) => {
  if (annotation.annotationType === "note") {
    return <span>{abbreviate(annotation.annotation.text, 1000)}</span>;
