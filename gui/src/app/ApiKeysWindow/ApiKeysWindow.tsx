...
import useNeurosiftSavedChats from "neurosift-lib/pages/SavedChatsPage/useNeurosiftSavedChats";
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <input
                type="password"
                value={keys.dandiStagingApiKey}
                onChange={(e) =>
                  keysDispatch({
                    type: "setDandiStagingApiKey",
                    value: e.target.value,
                  })
                }
              />
...
type NeurosiftAnnotationsLoginViewProps = {
  onLoggedIn?: () => void;
  onClose?: () => void;
};

export const NeurosiftAnnotationsLoginView: FunctionComponent<
  NeurosiftAnnotationsLoginViewProps
> = ({ onLoggedIn, onClose }) => {
  ...
  const { setNeurosiftAnnotationsAccessToken, neurosiftAnnotationsUserId } =
    ...
    return (
      <div>
        <span style={{ color: "darkgreen" }}>
          You are signed in to Neurosift Annotations.
        </span>
        &nbsp;
        <Hyperlink
          onClick={() => {
      ...
      <div>
        ...
        <Hyperlink
          onClick={() => {
            ...
            window.open(
              "https://neurosift-annotations.vercel.app/logIn",
              "_blank",
