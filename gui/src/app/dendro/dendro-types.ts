...
export const isDendroJobInputParameter = (
  x: any,
): x is DendroJobInputParameter => {
...
export const isComputeResourceSpecProcessorParameter = (
  x: any,
): x is ComputeResourceSpecProcessorParameter => {
  return validateObject(x, {
    name: isString,
    description: isString,
    type: isString,
...
export const isComputeResourceSpecProcessorInput = (
  x: any,
): x is ComputeResourceSpecProcessorInput => {
  return validateObject(x, {
    name: isString,
    description: isString,
    list: isBoolean,
...
export const isComputeResourceSpecProcessorInputFolder = (
  x: any,
): x is ComputeResourceSpecProcessorInputFolder => {
  return validateObject(x, {
    name: isString,
    description: isString,
    list: isBoolean,
...
export const isComputeResourceSpecProcessorOutput = (
  x: any,
): x is ComputeResourceSpecProcessorOutput => {
  return validateObject(x, {
    name: isString,
    description: isString,
  });
...
export const isComputeResourceSpecProcessorOutputFolder = (
  x: any,
): x is ComputeResourceSpecProcessorOutputFolder => {
  return validateObject(x, {
    name: isString,
    description: isString,
  });
...
export const isComputeResourceSpecProcessorAttribute = (
  x: any,
): x is ComputeResourceSpecProcessorAttribute => {
  return validateObject(x, {
    name: isString,
    value: () => true,
  });
...
export const isComputeResourceSpecProcessorTag = (
  x: any,
): x is ComputeResourceSpecProcessorTag => {
  return validateObject(x, {
    tag: isString,
  });
};
...
export const isComputeResourceSpecProcessor = (
  x: any,
): x is ComputeResourceSpecProcessor => {
  return validateObject(
    x,
    {
      name: isString,
      ...
      inputFolders: optional(
        isArrayOf(isComputeResourceSpecProcessorInputFolder),
      ),
      outputs: isArrayOf(isComputeResourceSpecProcessorOutput),
      outputFolders: optional(
        isArrayOf(isComputeResourceSpecProcessorOutputFolder),
      ),
...
export const isDendroJobUsedResources = (
  x: any,
): x is DendroJobUsedResources => {
  return validateObject(x, {
    numCpus: isNumber,
    numGpus: isNumber,
    memoryGb: isNumber,
...
// obsolete
export const isComputeResourceAwsBatchOpts = (
  x: any,
): x is ComputeResourceAwsBatchOpts => {
  return validateObject(x, {
...
// obsolete
export const isComputeResourceSlurmOpts = (
  x: any,
): x is ComputeResourceSlurmOpts => {
  return validateObject(x, {
...
export const isDendroComputeResourceApp = (
  x: any,
): x is DendroComputeResourceApp => {
  return validateObject(x, {
    name: isString,
...
export const isComputeResourceSpecApp = (
  x: any,
): x is ComputeResourceSpecApp => {
  return validateObject(x, {
    name: isString,
    description: isString,
...
export const isComputeResourceSpec = (x: any): x is ComputeResourceSpec => {
  return validateObject(x, {
    ...
    defaultJobRunMethod: optional(
      isOneOf([isEqualTo("local"), isEqualTo("aws_batch"), isEqualTo("slurm")]),
    ),
    availableJobRunMethods: optional(
      isArrayOf(
        isOneOf([
          isEqualTo("local"),
          isEqualTo("aws_batch"),
...
export const isProcessorGetJobResponseInput = (
  x: any,
): x is ProcessorGetJobResponseInput => {
  return validateObject(x, {
    name: isString,
    url: isString,
  });
...
export const isProcessorGetJobResponseInputFolderFile = (
  x: any,
): x is ProcessorGetJobResponseInputFolderFile => {
  return validateObject(x, {
    name: isString,
    url: isString,
...
export const isProcessorGetJobResponseInputFolder = (
  x: any,
): x is ProcessorGetJobResponseInputFolder => {
  return validateObject(x, {
    name: isString,
...
export const isProcessorGetJobResponseOutput = (
  x: any,
): x is ProcessorGetJobResponseOutput => {
  return validateObject(x, {
    name: isString,
  });
};
...
export const isProcessorGetJobResponseOutputFolder = (
  x: any,
): x is ProcessorGetJobResponseOutputFolder => {
  return validateObject(x, {
    name: isString,
  });
};
...
export const isProcessorGetJobResponseParameter = (
  x: any,
): x is ProcessorGetJobResponseParameter => {
  return validateObject(x, {
    name: isString,
    value: isString,
  });
...
export const isProcessorGetJobResponse = (
  x: any,
): x is ProcessorGetJobResponse => {
  return validateObject(x, {
    jobId: isString,
    status: isString,
    processorName: isString,
...
export const isComputeResourceUserUsage = (
  x: any,
): x is ComputeResourceUserUsage => {
  return validateObject(x, {
    computeResourceId: isString,
    userId: isString,
