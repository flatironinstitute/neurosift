...
const formatTimestamp = (t: number | undefined) => {
    ...
    const numMinutes = Math.floor((t - numDays * 24 * 3600 - numHours * 3600) / 60)
    const numSeconds = Math.floor(t - numDays * 24 * 3600 - numHours * 3600 - numMinutes * 60)
    const numMilliseconds = Math.floor((t - numDays * 24 * 3600 - numHours * 3600 - numMinutes * 60 - numSeconds) * 1000)
    const numMicroseconds = Math.floor((t - numDays * 24 * 3600 - numHours * 3600 - numMinutes * 60 - numSeconds - numMilliseconds / 1000) * 1000000)
    let ret = ''
