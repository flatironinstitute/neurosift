...
const PositionDecodeFieldFileView: FunctionComponent<Props> = ({width, height, filePath}) => {
    ...
    useEffect(() => {
        ...
        ;(async () => {
            ...
            setViewData({
                ...
                positionDecodeFieldUri: `rtcshare://${filePath}`
            })
        })()
        return () => {canceled = true}
...
export default PositionDecodeFieldFileView