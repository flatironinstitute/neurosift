...
async function draw() {
    ...
    const {margins, canvasWidth, canvasHeight, visibleStartTimeSec, visibleEndTimeSec, minValue, maxValue, zoomInRequired} = opts
    ...
    if (zoomInRequired) {
        ...
        canvasContext.fillText('Zoom in (mouse-wheel) to view data', canvasWidth / 2, canvasHeight / 2)
        return
    }
