...
import { Dialog, DialogContent, DialogTitle, TextField, Select, MenuItem, Button, Box, FormControl, InputLabel } from '@mui/material';
...
const SpikeSortingDialog: FunctionComponent<Props> = ({open, onClose, onSubmit, defaultStartTime, defaultEndTime}) => {
            ...
            <DialogContent>
                <Box component="form" onSubmit={handleSubmit} sx={{
                    ...
                    <Box sx={{
                        ...
                        <Button type="submit" variant="contained">Start Spike Sorting</Button>
                    </Box>
                </Box>
            </DialogContent>
        </Dialog>
