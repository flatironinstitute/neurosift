...
import { PSTHPrefs, PSTHTrialAlignedSeriesMode } from "./types";
...
const PSTHUnitAlignToWidget: FunctionComponent<PSTHUnitAlignToWidgetProps> = ({
  ...
  }, [nwbUrl, path, alignToVariable, trialIndices]);
  ...
  }, [nwbUrl, path, groupByVariable, spikeTrain]);
  ...
  const filteredTrials = useMemo(() => {
    ...
    return trials.filter((_trial, i) => trialIndicesSet.has(i));
  }, [trials, trialIndices]);
...
const PSTHGroupLegend: FunctionComponent<PSTHGroupLegendProps> = ({
  ...
  }, [nwbUrl, path, groupByVariable, groupByVariableCategories]);
