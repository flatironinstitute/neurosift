...
const SequentialRecordingsTableView: React.FC<Props> = ({
    ...
    const timeRange = visibleStartTimeSec !== undefined && visibleEndTimeSec !== undefined
        ? {
    ...
    return (
        ...
        >
            ...
            <div style={{
                ...
                <div style={{ fontWeight: "bold", marginBottom: "10px", color: "#1976d2" }}>
                ...
                {Object.keys(group.attrs).length > 0 && (
                    <div>
                        <strong>Description:</strong> {group.attrs.description || "No description available"}
                    </div>
                )}
            </div>
