      ...
      return (
        <div className="hdf5-tree-node">
          ...
          >
            ...
            <span
              className="tree-icon"
              style={{ color: tableItem.expanded ? "#e67e22" : "#f39c12" }}
            >
      ...
      return (
        <div className="hdf5-tree-node">
          ...
          >
            ...
            <span className="tree-icon" style={{ color: "#3498db" }}>
              <FaFile />
            </span>
            <span className="tree-label">{tableItem.name}</span>
    ...
    case "attribute":
      return (
        <div className="hdf5-tree-node">
          ...
          >
            <span className="tree-expander" />
            <span className="tree-icon" style={{ color: "#aaa", fontSize: 11 }}>
              <FaTag />
            </span>
            <span className="tree-label">
              {tableItem.name}
              <span style={{ color: "#999", margin: "0 4px" }}>=</span>
              <span style={{ color: "#555", fontFamily: "'SF Mono', 'Fira Code', monospace", fontSize: 12 }}>
