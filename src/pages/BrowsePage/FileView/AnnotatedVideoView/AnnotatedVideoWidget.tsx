...
const AnnotatedVideoWidget: FunctionComponent<Props> = ({width, height, currentTime, setCurrentTime, videoUri, videoWidth, videoHeight, videoNumFrames, samplingFrequency, annotationsUri, nodes, positionDecodeFieldUri}) => {
